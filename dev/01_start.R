...
##
# golem::fill_desc(
#   pkg_name = "austraits.portal", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
usethis::use_code_of_conduct(contact = "Daniel Falster")
